        ...
        <div className='modal-container'>
            <div className='bg-indigo-700 text-center p-5 h-96 lg:w-[500px] rounded shadow-md'>
             ...
             <form className='px-4'>
                {/* email */}
                <div className='mb-5'>
                    <input type="email" name='email' id='email' placeholder='example@gmail.com' className='w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B72B0] outline-none focus:border-[#6a54f1] focus:shadow-md'/>
                </div>
                <div className='mb-5'>
                    <input type="password" name='password' id='password' placeholder='enter your password' className='w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B72B0] outline-none focus:border-[#6a54f1] focus:shadow-md'/>
                </div>
                <div>
