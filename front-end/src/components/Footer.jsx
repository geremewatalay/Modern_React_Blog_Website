...
const Footer = () => {
  return (
    <div className='bg-gray-900'>
        <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
            <div className='grid mb-8 lg:grid-cols-6'>
                ...
                <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <form className='mt-4 flex flex-col md:flex-row'>
                            <input type="email" name='email' id='email' className='flex-grow w-full h-12 px-4 mb-3 transitio duration-200 bg-white border border-gray-300 rounded shadow-sm aspect-auto md:mr-2 md:mb-0 focus:border-purple-400 focus:outline-none' />
                            <button type='submit' className='inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transitio duration-200 rounde shadow-md hover:bg-ora focus:outline-none border'>
                              Subscribe
                            </button>
                        </form>
                        <p className='mt-4 text-sm text-gray-500'>🌟 Join Ethio Beteseb Academy – Unlock Your Child’s Full Potential! 📚✨

At Ethio Beteseb Academy, we offer top-quality 🏅 home-to-home tutoring for students in Grades 6️⃣, 8️⃣, and 1️⃣2️⃣.</p>
